...
function messageTemplate(screen_name, link){
    return `ding! dong!! Hi @${screen_name} click ${link} to download. you can always visit http://www.savetwittervideo.me/downloads/${screen_name} to download your recent videos`
  }
